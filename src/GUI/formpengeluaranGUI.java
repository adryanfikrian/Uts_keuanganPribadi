 ...
 * @author user
 */
public class formpengeluaranGUI extends javax.swing.JFrame {
private String tgl;

    /**
     * Creates new form FormpemasukanGUI
     */
    public formpengeluaranGUI() {
        initComponents();
        table();
    }
    ...
    tbl.addColumn("Nominal Pengeluaran");
    ...
    try {
        ...
        java.sql.ResultSet rs = statement.executeQuery("SELECT * FROM pengeluaran");

        while (rs.next()) {
            tbl.addRow(new Object[]{
                    rs.getInt("idpengeluaran"),
                    rs.getString("jumlahpengeluaran"),
                    rs.getDate("tanggalpengeluaran"),
                    rs.getString("deskripsipengeluaran")
            });
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Menu Pengeluaran Uang");

        jLabel5.setIcon(new javax.swing.ImageIcon("D:\\uangmasuk-removebg-preview-removebg-preview.png")); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(desktext, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)))
                        .addGap(8, 8, 8))
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String sql = "UPDATE pengeluaran SET jumlahpengeluaran = '"+masuktext.getText()
            +"',tanggalpengeluaran = '"+tgl
            +"', deskripsipengeluaran = '"+desktext.getText()
            +"' WHERE idpengeluaran='" +idtext.getText() + "'";
            stat.execute(sql);
            table();
